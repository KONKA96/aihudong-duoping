                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    	<div  class="dataTables_wrapper form-inline" role="grid">
                    		<!-- 查询条件 -->
	                    	<form method="post" id="searchForm" action="/aihudong-duoping-web/teacher/showAllTeacher">
		                    	<div class="row">
		                    		<div class="col-sm-2">
		                    			<div class="dataTables_length">
		                    				<a href="/aihudong-duoping-web/teacher/toUpdate" class="btn btn-primary ">新增用户</a>
		                    			</div>
		                    		</div>
		                    		<div class="col-sm-10">
                    		...
                    		<form method="POST"  enctype="multipart/form-data" id="form1" action="/aihudong-duoping-web/teacher/uploadExcel">  
						        <table>  
						        <tr>  
	                            ...
	                            <tbody>
	                            	<c:forEach items="${teacherList }" var="teacher">
	                            		<tr class="gradeA">
			                                 ...
			                                 <td>
			                                 	<a href="/aihudong-duoping-web/teacher/toUpdate?id=${teacher.id }"><i style="margin-left:5px;" class="fa fa-edit"></i></a>
							...
							<jsp:include page="../common/include_page.jsp">
 								<jsp:param value="/aihudong-duoping-web/teacher/showAllTeacher" name="pageTitle"/>
							</jsp:include>
							<!-- 分页结束 -->
                    </div>
                    </div>
...
function changeSubject(object){
	...
	function deleteTeacher(id){
		...
		if(f){
			$.ajax({
				url:"/aihudong-duoping-web/teacher/deleteTeacher",
				data:"id="+id,
				type:"post",
