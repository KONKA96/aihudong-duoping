                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="/aihudong-duoping-web/admin/toAdminInfo">个人资料</a>
                                </li>
                               <!--  <li><a class="J_menuItem" href="contacts.html">联系我们</a>
                                ...
                                <li class="divider"></li>
                                <li><a href="/aihudong-duoping-web/admin/adminLogout" onclick="return confirm('${admin.truename},你确定要退出了吗？')">安全退出</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <c:if test="${admin.power==0 }">
	                        <li>
	                                ...
	                                <ul class="nav nav-third-level">
	                                    	<li>
	                                    		<a href="/aihudong-duoping-web/teacher/showAllTeacher" class="J_menuItem">教师管理</a>
	                                    		<a href="/aihudong-duoping-web/student/showAllStudent" class="J_menuItem">学生管理</a>
	                                    	</li>
	                                </ul>
	                        </li>
			                <li>
