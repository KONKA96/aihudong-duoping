...
public class TestSha1 {
	public static String testSha1(String token,String tenant,String user) throws NoSuchAlgorithmException, UnsupportedEncodingException {
		SortedMap<String, String> sortSignParams = new TreeMap<String, String>();
		sortSignParams.put("token", token);
